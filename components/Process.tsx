const steps = [
  ...
  },
  {
    ...
    title: "Демосайт — безкоштовно",
    text: "Показую, як виглядатиме ваш сайт. До будь-якої оплати й без зобов'язань.",
    free: true,
  },
  {
    num: "03",
    ...
    <section className="section proc" id="process">
      <div className="wrap">
        <div className="section__head reveal">
          ...
          <div className="proc__badges">
            <div className="proc__badge">
              <i className="fa-solid fa-bolt-lightning"></i>Сайт за 1–3 дні
            </div>
            <div className="proc__badge proc__badge--free">
              <i className="fa-solid fa-gift"></i>Демосайт безкоштовно
            </div>
          </div>
        </div>
        <div className="steps">
          {steps.map((s) => (
            <div key={s.num} className={`step reveal${s.free ? " step--free" : ""}`}>
